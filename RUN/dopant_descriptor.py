...
#########################################################
    ...
    MM = obj_dos.Magnetic_moment()
    State = primary_feature.Dopant_feature(met,site,rutile_type)[0]
    Enthalpy = primary_feature.Dopant_feature(met,site,rutile_type)[1]
    CR = primary_feature.Dopant_feature(met,site,rutile_type)[2]
    IR = primary_feature.Dopant_feature(met,site,rutile_type)[3]
    AR = primary_feature.Dopant_feature(met,site,rutile_type)[4]
    write_data('/p/project/lmcat/wenxu/data/feature',folname, MM, State, Enthalpy, CR, IR, AR)
    os.chdir(pathway)
  ...
  #  ##     obj_dos.dos_collect()
  #  ##     obj_Geomerty=primary_feature.Geometry(site)
  #      ##     foldsite_111=obj_Geomerty.Site_1fold_111(folname,rutile_type)
  #      ##     write_data('/p/project/lmcat/wenxu/data/feature',folname,dbs,foldsite_111)
  ...
  #  IP = primary_feature.Atomic_feature(met,site,rutile_type)[1]
  ...
  #  # print 'bader_aver_Oxygen',aver_Oxygen
    #write_data('/p/project/lmcat/wenxu/data/feature',folname, WF, formation_energy, dbc, dbw, dbs, dbk, un_dbc, Eg_band_center,
    #            T2g_band_center,O2p_band_center, Max_d, Max_2p_band, PE, IP, EA, ME, O_1fold, Near_1,Near_2,Near_3, Rela_dis, radius,          
    #            Local_1, Local_2, Local_3, Local_4, Local_5, Local_6, Vad2, d_band_filling, Eg_band_filling,T2g_band_filling, O2p_band_filling,
    #            fraction_unfilling, bader_charge,aver_metal,aver_Oxygen, Dos_fermi, O2p_fermi)
